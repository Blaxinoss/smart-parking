...
import { CarFront, MapPin } from "lucide-react-native";
      ...
      <View className="flex-1 p-5">
        ...
        <View className="items-center mb-4 mt-2 flex flex-row justify-center ">
          <View className="bg-main-900/10 p-2 rounded-full  border border-main-900/20">
            <MapPin
              size={20}
              color="#eab308" /* استبدل الكود بلون الـ main بتاعك */
            />
          </View>
          ...
          <FlatList
            ...
            renderItem={({ item, index }) => {
              ...
              const getStatusColor = () => {
                ...
                if (isEmergency && !isOccupied && !isAssigned && !isReserved)
                  return "border-red-500/40 bg-red-950/20 border-dashed";
                  ...
                  <View className="flex-1 items-center justify-center">
                    {isOccupied ? (
                      ...
                      <View className="items-center animate-pulse">
                        ...
                        <StyledText className="text-blue-400 text-[10px] font-titillium-bold mt-1">
                          RESERVED
                        </StyledText>
                      </View>
                    ) : isAssigned ? (
                      <View className="items-center">
                        ...
                        <StyledText className="text-purple-400 text-[10px] font-titillium-bold mt-1">
                          INCOMING
                        </StyledText>
                      </View>
                    ) : (
                      <StyledText className="text-4xl font-black text-green-500/10">
                        P
                      </StyledText>
                    )}
                  </View>
