      ...
      <View className="flex-1 p-6 justify-center bg-black">
        ...
        <View className="gap-2">
          <InputFieldNaked
            ...
            errorMessage={
              errorMsg.toLowerCase().includes("email") ? errorMsg : ""
            }
          />
          <InputFieldNaked
            ...
            errorMessage={
              errorMsg.toLowerCase().includes("password") ? errorMsg : ""
            }
          />
          <View className="mt-4 gap-4">
            ...
            <Button Icon={UserRoundKey} title="Sign in with Google" />
          </View>
          <View className="flex-row justify-center gap-1 mt-6">
            <StyledText className="text-garage-500">
        ...
        {errorMsg !== "" &&
          ...
          !errorMsg.toLowerCase().includes("password") && (
            <Alert
              icon={Terminal}
              className="mt-6 border-destructive bg-garage-950"
            >
