    ...
    >
      ...
      >
        ...
        >
          <BellRing
            size={16}
            color={unresolvedAlerts > 0 ? "#F97C7C" : "#888"}
          />
          {unresolvedAlerts > 0 && (
            <View
              style={{
      ...
      <View style={{ flexDirection: "row", gap: 8, marginBottom: 24 }}>
        <QuickAction
          icon={<Plus size={16} color="#E7872E" />}
          label="New slot"
          tint="#E7872E"
          onPress={() => setActiveSection("slots")}
        />
        <QuickAction
          icon={<UserPlus size={16} color="#64a0ff" />}
          label="Add user"
          tint="#64a0ff"
          onPress={() => setActiveSection("users")}
        />
        <QuickAction
          icon={<BellRing size={16} color="#F97C7C" />}
          label="Alerts"
          tint="#F97C7C"
          onPress={() => setActiveSection("alerts")}
        ...
        />
        <QuickAction
          icon={<DoorOpen size={16} color="#50c882" />}
          label="Gates"
          tint="#50c882"
          onPress={() => setActiveSection("gates")}
        />
        <QuickAction
          icon={<DoorClosed size={16} color="#50c882" />}
          label="Sign out"
          tint="#50c882"
      ...
      >
        <NavItem
          icon={
            <LayoutDashboard
              size={20}
              color={activeTab === "dashboard" ? "#E7872E" : "#444"}
            />
          }
          label="Dashboard"
        ...
        <NavItem
          icon={
            <CalendarClock
              size={20}
              color={activeTab === "reservations" ? "#E7872E" : "#444"}
            />
          }
          label="Reservations"
        ...
        <NavItem
          icon={
            <CreditCard
              size={20}
              color={activeTab === "finance" ? "#E7872E" : "#444"}
            />
          }
          label="Finance"
        ...
        <NavItem
          icon={
            <Settings
              size={20}
              color={activeTab === "settings" ? "#E7872E" : "#444"}
            />
          }
          label="Settings"
      ...
      >
        <SafeAreaView style={{ flex: 1, backgroundColor: "#0a0a0a" }}>
          ...
          >
            ...
            >
              <Text style={{ color: "#888", fontSize: 16, lineHeight: 18 }}>
                ✕
              </Text>
            </Pressable>
          </View>
        ...
        {badge ? (
          <View
            style={{
              ...
              borderWidth: 0.5,
              borderColor: "rgba(249,124,124,0.3)",
              borderRadius: 20,
              paddingHorizontal: 8,
              paddingVertical: 3,
            }}
...
function NavItem({
  ...
  return (
    ...
    >
      {icon}
      <Text style={{ color: active ? "#E7872E" : "#444", fontSize: 9 }}>
        {label}
      </Text>
    </Pressable>
  );
